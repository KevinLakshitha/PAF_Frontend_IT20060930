...
public class Payments {
	...
	public Connection connect()
	{
	 ...
	 try
	 {
		 ...
		 con= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/pay", "root", "admin");
	 }
	 catch(Exception e)
	 {
		 e.printStackTrace();
...
//				 + "'>" + phone + "</td>"; 
	...
	//Insert function
	public String insertPay(String payID, String cusID, String pmethod, String date, String amount)
	{
	 String output = "";
	 try
	 {
	 ...
	 // Prepared statement
	 String query = " insert into payments(`noticeId`,`payID`,`cusID`,`pmethod`, `date`, `amount`)" + " values (?, ?, ?, ?,?,?)";
	...
	//Update function
	public String updatePay(String noticeId, String payID, String cusID, String pmethod, String date, String amount) 
	{
			 String output = "";
			 try
			 {
			 ...
			 String query = "update payments set payID=?, cusID=?, pmethod=?, date=?, amount=? where noticeId=?";
			 PreparedStatement preparedStmt = con.prepareStatement(query);
